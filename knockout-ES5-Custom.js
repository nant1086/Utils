...
(function (global, undefined) {
    ...
    function isObject(obj) {
        return !_.isEmpty(obj) && !_.isString(obj);
    }
    function trackDeep(object)
    {
        if (object.noTrack == undefined && isObject(object)) {
            for (var prop in object) {
                isObject(object[prop]) && //Valida si es objeto
                trackDeep(object[prop]);
            }
            track(object);
        }
    }
